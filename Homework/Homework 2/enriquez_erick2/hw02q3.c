...
void part1(int x) {
	...
	printf("Explanation: The error occured because the the value of m was incremented before it was passed \n\n\n"); // (5 points)
}
...
void part2(int x, int y) {
	...
	printf("Explanation: one of the reasons for the different values could be the fact that without parentheses to enmphasize order of operations the compilers evaluate math differently \n\n"); //  (5 points)
}
